...
$out_italic = $out_bold = $out_bolditalic = false;
...
# process input file
#
$sfd = @fopen( "AnkaCoder-Norm-Skel.sfd", "r" );
if ( false === $sfd ) die( "Can't open input file\n" );

#$out_italic = @fopen( "AnkaCoder-Norm-SkelI.sfd", "w" );
#if ( false === $out_italic ) die( "Can't open output file\n" );
$out_bold = @fopen( "AnkaCoder-Norm-SkelB.sfd", "w" );
if ( false === $out_bold ) die( "Can't open output file\n" );
$out_bolditalic = @fopen( "AnkaCoder-Norm-SkelBI.sfd", "w" );
